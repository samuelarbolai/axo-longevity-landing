...
export default function Landing2({ variant }) {
  ...
  return (
    ...
    >
      <h2 className="text-6xl font-serif font-extralight text-[#2c2c2c] relative z-10">{t.longLiveYou}</h2>
      <p className="text-6xl font-cursive font-extralight text-[#2c2c2c] max-w-5xl leading-relaxed">
