...
export default function Landing4() {
  ...
  return (
    <section id="our-services" className="bg-[#fef9ef] px-6 md:px-20 py-10 lg:py-24 text-[#3c3d42]">
      <h2 className="text-5xl md:text-6xl font-serif font-extralight text-center mx-auto">
        <span className="text-gray-500">{t.membershipPrefix} </span>
        <span className="italic text-[#b4735a]">{t.membershipSuffix}</span>
      </h2>
